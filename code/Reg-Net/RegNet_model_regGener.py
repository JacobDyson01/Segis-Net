...
#https://stackoverflow.com/questions/44186042/keras-methods-to-enlarge-spartial-dimension-of-the-layer-output-blob
    ...
    conv_2 = ConvBlockA(pool_1, num_start_ch*2, num_start_ch*2, alpha) #2^(i-1)
...
class DataGenerator(object):
  ...
  def __data_generation(self, list_IDs_temp, img_path, affine_path):
      ...
      for i, ID in enumerate(list_IDs_temp):
          ...
          # nfity
          tgt_p   = join(img_path, str(ID1), 'image_name.nii.gz')
          src_p   = join(img_path, str(ID2), 'image_name.nii.gz')
