...
affine_data_dir = '/home/groups/dlmrimnd/jacob/data/MND/deformation_fields_reversed_roi'  # Corrected path for affine deformations
output_segmentation_dir = '/home/groups/dlmrimnd/jacob/data/MND/output_segmentations_final_reversed'
...
for subject_dir in os.listdir(input_data_dir):
    ...
    if os.path.isdir(subject_path):
        ...
        source_file = os.path.join(subject_path, 'target_Warped_roi.nii.gz')
        target_file = os.path.join(subject_path, 'source_Warped_roi.nii.gz')
