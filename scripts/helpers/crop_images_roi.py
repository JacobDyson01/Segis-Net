...
crop_coords = (48, 192, 0, 144, 48, 192)

# Directories
input_dir = "/home/groups/dlmrimnd/jacob/data/input_images"
output_dir = "/home/groups/dlmrimnd/jacob/data/input_images_roi"
...
for sub_dir in os.listdir(input_dir):
    ...
    src_img = os.path.join(input_dir, sub_dir, "source.nii.gz")
    tgt_img = os.path.join(input_dir, sub_dir, "target.nii.gz")
    src_roi = os.path.join(output_dir, sub_dir, "source_roi.nii.gz")
    tgt_roi = os.path.join(output_dir, sub_dir, "target_roi.nii.gz")
