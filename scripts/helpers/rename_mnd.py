...
warped_input_dir = '/home/groups/dlmrimnd/jacob/data/volumes_MND'
...
for folder_name in os.listdir(warped_input_dir):
    ...
    if os.path.isdir(folder_path) and '_ses-' in folder_name:
        # Replace underscores with hyphens for session identifiers
        new_folder_name = folder_name.replace('_ses-', '_ses_')
