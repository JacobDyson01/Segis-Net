...
output_dir="/home/groups/dlmrimnd/jacob/data/MND/deformation_fields_reversed"
...
for sub_dir in ${input_dir}/sub-*; do
    ...
    target_img="${sub_dir}/warped_source_Warped.nii.gz"
    source_img="${sub_dir}/warped_target_Warped.nii.gz"
