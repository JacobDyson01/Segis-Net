...
data_dir = "/home/groups/dlmrimnd/jacob/data/volumes_percent_MND_segis_net"
...
plt.title('Percentage of Volume of ROI in Segis-Net Segmentation (BeLong)')
plt.grid(True)
...
output_path = os.path.join(output_dir, "percentage_volume_vs_session_MND_volumes_segis_net.png")
